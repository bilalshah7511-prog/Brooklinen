...
export default function App() {
  ...
  function applyPromo() {
    ...
    if (!code) return;
    const catalog = {
      BROOKLINEN10: { type: 'percent', value: 10 },
    ...
    <>
      ...
      <header className="site-header">
        <div className="site-header__row">
          ...
          <a href="#" className="site-logo" aria-label="Brooklinen">
            <img src={brand.logoSrc} alt="Brooklinen" />
          </a>
      ...
      <div className={`mobile-menu${menuOpen ? ' is-open' : ''}`}>
        <div className="mobile-menu__body">
          ...
          <nav className="mobile-menu__nav">
            <a href="#" className="mobile-menu__nav-main">bedding</a>
            <a href="#" className="mobile-menu__nav-main">bath</a>
            <a href="#" className="mobile-menu__nav-main">bundles</a>
          </nav>
        </div>
      </div>
      ...
      <StatusOverlay
        ...
        type="check"
        title="Order placed"
        text="Your Brooklinen order is on the way."
        onDone={() => {
